    ...
    return (
        <div className='days day29'>
            <form className='day29__form'>
                <label htmlFor='search' className='day29__logo-container' focusable="false">
                ...
                <input autoComplete="off" id='search' value={keyword} onChange={(e)=>{setKeyword(e.target.value);console.log(e.target.value)}} className='day29__search' type="text" placeholder='Start typing ...' />
