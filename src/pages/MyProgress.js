...
const MyProgress = () => {
  const {pageData, daysData} = useContext(LanguageContext)
  return (
    <div className='main-app myProgress text-sm-center'>
        <section className='section w-100 w-md-75 m-auto'>
            ...
            <h2 className='h2'>
              {pageData.pages.progress.h2} 
              <span className='color'>@sergio-ivan-melgarejo</span> 
            </h2>
            <p className='text'>
              {pageData.pages.progress.text}
            </p>
            <div className='container-buttons'>
                <a href="https://codepen.io/sergio-ivan-melgarejo" target="_blank" rel='noreferrer' className='button d-flex justify-content-center m-auto'>
                    ...
                    <span>{pageData.pages.progress.button}</span>    
                </a>    
            </div>
        </section>
        <DailyProgress daysData={daysData} title={pageData.pages.progress["h3"]} />
    </div>
  )
}
