...
const MyProgress = ({jsonData}) => {
  return (
    <div className='main-app myProgress text-sm-center'>
        <section className='section w-100 w-md-75 m-auto'>
            <h1 className='title'>100 DAYS CSS CHALLENGE</h1>
            <h2 className='h2'>Progress of <span className='color'>@sergio-ivan-melgarejo</span> </h2>
            <p className='text'>The unvarnished truth. Check out the progress on the 100 Days CSS Challenge and see all the submitted Pens.</p>
            <div className='container-buttons'>
                <a href="https://codepen.io/sergio-ivan-melgarejo" target="_blank" rel='noreferrer' className='button d-flex justify-content-center m-auto'>
        ...
        <DailyProgress jsonData={jsonData} />
    </div>
  )
}
