...
const Card = ({jsonData}) => {
  ...
  if(day > jsonData.length) day = jsonData.length;
  if(day < 1) day = 1;
  ...
  return (
    ...
    <div className='footer'>
      <div className="container-button">
        ...
        <Link to={`/days/${day >= jsonData.length ? 1 : (day + 1)}`} className="button-change">
        ...
        <div className='container-button'>
          <a href={jsonData[day - 1].codepen} target="_blank" rel="noreferrer" className='codePen'>
